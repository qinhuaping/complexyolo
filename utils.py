    ...
    for j in range(num_obj):
        ...
        if obj_class in class_list:
             ...
             if  (location_x>0) & (location_x<40) & (location_y>-40)  & (location_y<40) :
                  ...
                  obj_alpha = -1*(float)(obj[14].strip())-(np.pi/2)           # get target Observation angle of object, ranging [-pi..pi]
                  s = (float)(obj_alpha)*180.0/3.1415926
